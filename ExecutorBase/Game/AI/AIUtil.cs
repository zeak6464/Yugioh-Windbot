...
namespace WindBot.Game.AI
{
    public class AIUtil
    {
        ...
        public int GetBotAvailZonesFromExtraDeck(IList<ClientCard> remove)
        {
            ...
            if (BotMZone[0] == null &&
                ((BotMZone[1] != null && BotMZone[1].HasLinkMarker(CardLinkMarker.Left)) ||
                 (BotMZone[5] != null && BotMZone[5].HasLinkMarker(CardLinkMarker.BottomLeft)) ||
                 (EnemyMZone[6] != null && EnemyMZone[6].HasLinkMarker(CardLinkMarker.TopRight))))
                result |= Zones.z0;

            if (BotMZone[1] == null &&
                ((BotMZone[0] != null && BotMZone[0].HasLinkMarker(CardLinkMarker.Right)) ||
                 (BotMZone[2] != null && BotMZone[2].HasLinkMarker(CardLinkMarker.Left)) ||
                 (BotMZone[5] != null && BotMZone[5].HasLinkMarker(CardLinkMarker.Bottom)) ||
                 (EnemyMZone[6] != null && EnemyMZone[6].HasLinkMarker(CardLinkMarker.Top))))
                result |= Zones.z1;

            if (BotMZone[2] == null &&
                ((BotMZone[1] != null && BotMZone[1].HasLinkMarker(CardLinkMarker.Right)) ||
                 (BotMZone[3] != null && BotMZone[3].HasLinkMarker(CardLinkMarker.Left)) ||
                 (BotMZone[5] != null && BotMZone[5].HasLinkMarker(CardLinkMarker.BottomRight)) ||
                 (EnemyMZone[6] != null && EnemyMZone[6].HasLinkMarker(CardLinkMarker.TopLeft)) ||
                 (BotMZone[6] != null && BotMZone[6].HasLinkMarker(CardLinkMarker.BottomLeft)) ||
                 (EnemyMZone[5] != null && EnemyMZone[5].HasLinkMarker(CardLinkMarker.TopRight))))
                result |= Zones.z2;

            if (BotMZone[3] == null &&
                ((BotMZone[2] != null && BotMZone[2].HasLinkMarker(CardLinkMarker.Right)) ||
                 (BotMZone[4] != null && BotMZone[4].HasLinkMarker(CardLinkMarker.Left)) ||
                 (BotMZone[6] != null && BotMZone[6].HasLinkMarker(CardLinkMarker.Bottom)) ||
                 (EnemyMZone[5] != null && EnemyMZone[5].HasLinkMarker(CardLinkMarker.Top))))
                result |= Zones.z3;

            if (BotMZone[4] == null &&
                ((BotMZone[3] != null && BotMZone[3].HasLinkMarker(CardLinkMarker.Right)) ||
                 (BotMZone[6] != null && BotMZone[6].HasLinkMarker(CardLinkMarker.BottomRight)) ||
                 (EnemyMZone[5] != null && EnemyMZone[5].HasLinkMarker(CardLinkMarker.TopLeft))))
                result |= Zones.z4;
