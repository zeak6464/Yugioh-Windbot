...
namespace WindBot.Game.AI.Decks
{
    ...
    public class LightswornShaddoldinosour : DefaultExecutor
    {
        ...
        {
            //counter            
            AddExecutor(ExecutorType.Activate, CardId.GhostOgreAndSnowRabbit, Hand_act_eff);
        ...
        {
            if (Card.IsCode(CardId.GhostOgreAndSnowRabbit) && Card.Location == CardLocation.Hand && Bot.HasInMonstersZone(CardId.GhostOgreAndSnowRabbit)) return false;
        ...
        private bool Michaeleff()
        {
            ...
            ClientCard select = Util.GetBestEnemyMonster();
        ...
        public bool CrystronNeedlefibereff()
        {
            ...
            {
                if (card.IsCode(CardId.DarkHole) && card.IsFaceup())
                {
                    DarkHole = true;
                }
            }
