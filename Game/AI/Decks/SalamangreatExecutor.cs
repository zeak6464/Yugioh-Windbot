...
namespace WindBot.Game.AI.Decks
{
    ...
    class SalamangreatExecutor : DefaultExecutor
    {
        ...
        public class CardId
        {
            ...
            public const int CrystalWingSynchroDragon = 21123811;
            public const int GamecieltheSeaTurtleKaiju = 88307361;
            public const int JizukirutheStarDestroyingKaiju = 51447164;
        ...
        public bool Called_activate()
        {
            ...
            {
                if (!Enemy.BattlingMonster.IsDisabled() && Enemy.BattlingMonster.IsCode(CardId.EaterOfMillions) && Enemy.HasInGraveyard(CardId.EaterOfMillions))
                {
            ...
            if (Duel.Phase == DuelPhase.BattleStart && Duel.Player == 1 &&
                Enemy.HasInMonstersZone(CardId.NumberS39UtopiaTheLightning, true) && Enemy.HasInGraveyard(CardId.NumberS39UtopiaTheLightning))
            {
